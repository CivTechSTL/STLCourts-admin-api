...
public class LoginController {
	...
	public NewTokenResponse googleSignIn(@RequestBody final BasicToken signInToken) throws NotAuthorizedException, GeneralSecurityException, IOException{
		NewTokenResponse result = loginManager.verifyGoogleTokenAndGetSecurityTokens(signInToken.getToken());
		return result;
	}
	
	@PostMapping(value = "refreshToken")
	public NewTokenResponse refreshToken(@RequestBody final BasicToken refreshToken) {
